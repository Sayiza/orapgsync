...
import me.christianrobert.orapgsync.transformation.semantic.expression.LogicalExpression;

public class VisitLogicalExpression {
  public static SemanticNode v(PlSqlParser.Logical_expressionContext ctx, SemanticTreeBuilder b) {
    ...
    SemanticNode unaryLogicalExpression = b.visit(unaryCtx);
    return new LogicalExpression(unaryLogicalExpression);
  }
}
