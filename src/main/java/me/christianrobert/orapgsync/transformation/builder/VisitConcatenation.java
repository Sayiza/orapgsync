...
public class VisitConcatenation {
  public static SemanticNode v(PlSqlParser.ConcatenationContext ctx, SemanticTreeBuilder b) {
    ...
    SemanticNode modelExpression = b.visit(modelCtx);
    return new Concatenation(modelExpression);
  }
}
